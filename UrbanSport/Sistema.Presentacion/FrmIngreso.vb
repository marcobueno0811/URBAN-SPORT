...
Public Class FrmIngreso
    ...
    Private Sub FormatoArticulos()
        ...
        DgvArticulos.Columns(5).Width = 200
        DgvArticulos.Columns(7).Width = 70
        DgvArticulos.Columns(8).Width = 75
        DgvArticulos.Columns(9).Width = 80
        'DgvListado.Columns(10).Width = 90
        DgvArticulos.Columns(11).Width = 90
    ...
    Private Sub CrearTablaDetalle()
        ...
        DgvDetalle.Columns(2).HeaderText = "MARCA"
        DgvDetalle.Columns(2).Width = 200
        DgvDetalle.Columns(3).HeaderText = "MODELO"
        DgvDetalle.Columns(3).Width = 200
        DgvDetalle.Columns(4).HeaderText = "IDTALLA"
        DgvDetalle.Columns(4).Width = 50

        DgvDetalle.Columns(5).HeaderText = "TALLA"
        ...
        DgvDetalle.Columns(9).HeaderText = "IMAGEN"
    ...
    Private Sub BtnBuscarArticulosDetalle_Click(sender As Object, e As EventArgs) Handles BtnBuscarArticulosDetalle.Click
        Try
            ...
            xtalla = TxtTallaD.Text
            DgvArticulos.DataSource = Neg.Buscar(Valor, xtalla)
    ...
    Private Sub DgvArticulos_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvArticulos.CellDoubleClick
        Try
            ...
            Obj.IdTalla = DgvArticulos.SelectedCells.Item(6).Value
        ...
        If (e.KeyCode = Keys.Enter) Then
            Try
                ...
                If (Obj Is Nothing) Then
                    MsgBox("No existe zapatillas con ese codigo de barras y esa talla", vbOKOnly + vbCritical, "No existe zapatilla")
                Else
    ...
    Private Sub DgvDetalle_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvDetalle.CellDoubleClick
        ...
        imagen = DgvDetalle.SelectedCells.Item(9).Value
        If (imagen <> "") Then
            FrmImagen.Show()
    ...
    Private Sub TxtTallaD_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtTallaD.KeyDown
        Try
            Dim Neg As New Negocio.NArticulo
            Dim Valor As String, xtalla As String
            Valor = TxtBuscarArticulos.Text
